...
REGISTRY: list[Biomarker] = [
    ...
    Biomarker(
        ...
        canonical_unit="g/dL",
        category="CBC",
        name_aliases=["hgb", "hb", "hemoglobin", "haemoglobin", "hgb.", "hemoglobin bld mcnc pt qn"],
        unit_conversions={
            "g/dl": 1, "g/100ml": 1,
            "gm/dl": 1, "gm/100ml": 1,
            "g/l": 0.1, "gm/l": 0.1,
    ...
    Biomarker(
        ...
        name_aliases=["mcv", "mean corpuscular volume", "mean cell volume",
                      "erythrocyte mean corpuscular volume rbc entvol pt qn"],
        unit_conversions={"fl": 1, "fL": 1, "femtoliter": 1},
    ...
    Biomarker(
        ...
        name_aliases=["mch", "mean corpuscular hemoglobin", "mean cell hemoglobin",
                      "erythrocyte mean corpuscular hemoglobin rbc entmass pt qn"],
        unit_conversions={"pg": 1, "picogram": 1},
    ...
    Biomarker(
        ...
        name_aliases=["mchc", "mean corpuscular hemoglobin concentration",
                      ...
                      "erythrocyte mean corpuscular hemoglobin concentration rbc mcnc pt qn"],
        unit_conversions={"g/dl": 1, "gm/dl": 1, "gm/dL": 1, "GM/DL": 1, "g/l": 0.1, "%": 1, "gram per deciliter": 1},
    ...
    Biomarker(
        ...
        name_aliases=["rdw", "rdw-cv", "rdw cv", "red cell distribution width",
                      ...
                      "erythrocyte distribution width rbc ratio pt qn"],
    ...
    Biomarker(
        ...
        canonical_unit="fL",
        category="CBC",
        name_aliases=["rdw-sd", "rdw sd",
                      "erythrocyte distribution width rbc entvol pt qn"],
        unit_conversions={"fl": 1, "": 1},
        ref_low=39.0, ref_high=46.0,
    ),
    Biomarker(
        ...
        name_aliases=["plt", "platelets", "platelet count", "thrombocytes",
                      "platelet", "platelets bld ncnc pt qn"],
        unit_conversions={
            "10³/µl": 1, "10^3/ul": 1, "k/ul": 1, "k/µl": 1,
            ...
            "x10(3)/mcl": 1,
        "thousand per microliter": 1, "varies": 1},
    ...
    Biomarker(
        ...
        canonical_unit="fL",
        category="CBC",
        name_aliases=["mpv", "mean platelet volume", "platelet mean volume bld entvol pt qn"],
        unit_conversions={"fl": 1, "femtoliter": 1},
    ...
    Biomarker(
        ...
        name_aliases=["neutrophils %", "neutrophils", "neutrophil %",
                      ...
                      "neutro %", "neutrophils #",
                      "granulocytes/100 leukocytes bld nfr pt qn",
                      "neutrophils/100 leukocytes bld nfr pt qn"],
        unit_conversions={"%": 1, "percent": 1},
    ...
    Biomarker(
        ...
        "number": 1, "thousand per microliter": 1},
    ...
    Biomarker(
        ...
        name_aliases=["lymphocytes %", "lymphocytes", "lymphocyte %",
                      "lymphs %", "lymphs", "lymph %",
                      "reactive lymph %", "lymphocytes/100 leukocytes bld nfr pt qn"],
        unit_conversions={"%": 1, "percent": 1},
    ...
    Biomarker(
        ...
        name_aliases=["monocytes %", "monocytes", "monocyte %", "monos %", "monos",
                      "mono %", "monocytes/100 leukocytes bld nfr pt qn"],
        unit_conversions={"%": 1, "percent": 1},
    ...
    Biomarker(
        ...
        name_aliases=["eosinophils %", "eosinophils", "eosinophil %",
                      "eos %", "eos", "eosinophils/100 leukocytes bld nfr pt qn"],
        unit_conversions={"%": 1, "percent": 1},
    ...
    Biomarker(
        ...
        name_aliases=["basophils %", "basophils", "basophil %",
                      "baso %", "basos %", "basos",
                      "basophils/100 leukocytes bld nfr pt qn"],
        unit_conversions={"%": 1, "percent": 1},
    ...
    Biomarker(
        ...
        name_aliases=["immature granulocytes", "immature granulocytes %",
                      "imm gran %", "ig %",
                      "granulocytes.immature/100 leukocytes bld nfr pt qn automated count"],
        unit_conversions={"%": 1, "percent": 1},
    ...
    Biomarker(
        ...
        name_aliases=["glucose", "blood glucose", "fasting glucose",
                      ...
                      "glucose ser/plas mcnc pt qn"],
        unit_conversions={
            "mg/dl": 1,
            "mmol/l": 18.018,
        "milligram per deciliter": 1},
    ...
    Biomarker(
        ...
        name_aliases=["bun", "blood urea nitrogen", "urea nitrogen",
                      ...
                      "urea nitrogen ser/plas mcnc pt qn"],
        unit_conversions={
            "mg/dl": 1,
            "mmol/l": 2.8,
        "milligram per deciliter": 1},
    ...
    Biomarker(
        ...
        name_aliases=["creatinine", "creat", "cr", "serum creatinine",
                      "creatinine serum", "creatinine ser/plas mcnc pt qn"],
        unit_conversions={
            "mg/dl": 1,
    ...
    Biomarker(
        ...
        "milliliter per minute per 1.73 square meter": 1},
    ...
    Biomarker(
        ...
        category="Metabolic",
        name_aliases=["sodium", "na", "na+", "sodium serum", "sodium lvl", "sodium ser/plas scnc pt qn"],
        unit_conversions={"meq/l": 1, "mmol/l": 1, "millimole per liter": 1},
    ...
    Biomarker(
        ...
        canonical_unit="mEq/L",
        category="Metabolic",
        name_aliases=["potassium", "k", "k+", "potassium serum", "potassium lvl", "potassium ser/plas scnc pt qn"],
        unit_conversions={"meq/l": 1, "mmol/l": 1, "millimole per liter": 1},
    ...
    Biomarker(
        ...
        canonical_unit="mEq/L",
        category="Metabolic",
        name_aliases=["chloride", "cl", "cl-", "chloride serum", "chloride ser/plas scnc pt qn"],
        unit_conversions={"meq/l": 1, "mmol/l": 1, "millimole per liter": 1},
    ...
    Biomarker(
        ...
        name_aliases=["co2", "carbon dioxide", "bicarbonate", "hco3",
                      "total co2", "co2 total", "carbon dioxide, total", "carbon dioxide bld scnc pt qn"],
        unit_conversions={"meq/l": 1, "mmol/l": 1, "millimole per liter": 1},
    ...
    Biomarker(
        ...
        name_aliases=["calcium", "ca", "total calcium", "calcium serum",
                      ...
                      "calcium, serum", "calcium,", "calcium ser/plas mcnc pt qn"],
        unit_conversions={
            "mg/dl": 1,
            "mmol/l": 4.008,
        "milligram per deciliter": 1},
    ...
    Biomarker(
        ...
        name_aliases=["protein", "total protein", "serum protein",
                      ...
                      "protein, total serum", "protein ser/plas mcnc pt qn"],
        unit_conversions={"g/dl": 1, "gm/dl": 1, "g/l": 0.1, "gram per deciliter": 1},
    ...
    Biomarker(
        ...
        canonical_unit="g/dL",
        category="Metabolic",
        name_aliases=["albumin", "alb", "albumin serum", "albumin lvl", "albumin ser/plas mcnc pt qn"],
        unit_conversions={"g/dl": 1, "gm/dl": 1, "g/l": 0.1, "gram per deciliter": 1},
    ...
    Biomarker(
        ...
        name_aliases=["globulin", "total globulin", "globulin serum",
                      "globulin, total", "globulin ser mcnc pt qn"],
        unit_conversions={"g/dl": 1, "gm/dl": 1, "g/l": 0.1, "gram per deciliter": 1},
    ...
    Biomarker(
        ...
        name_aliases=["a/g ratio", "albumin/globulin ratio", "ag ratio",
                      "a:g ratio", "albumin/globulin ser/plas mrto pt qn"],
        unit_conversions={"ratio": 1, "": 1},
    ...
    Biomarker(
        ...
        name_aliases=["bilirubin", "total bilirubin", "t bili", "t. bili",
                      "tbili", "bilirubin total", "bilirubin, total", "bilirubin ser/plas mcnc pt qn"],
        unit_conversions={
            "mg/dl": 1,
    ...
    Biomarker(
        ...
        name_aliases=["alkaline phosphatase", "alp", "alk phos", "alkphos",
                      ...
                      "alkaline phosphatase, s", "alkaline phosphatase ser/plas ccnc pt qn"],
        unit_conversions={"u/l": 1, "iu/l": 1, "units/l": 1, "intl_unit/l": 1, "unit per liter": 1, "international unit per liter": 1},
    ...
    Biomarker(
        ...
        name_aliases=["alt", "alanine aminotransferase", "alanine transaminase",
                      ...
                      "alanine aminotransferase ser/plas ccnc pt qn"],
        unit_conversions={"u/l": 1, "iu/l": 1, "units/l": 1, "intl_unit/l": 1, "unit per liter": 1, "international unit per liter": 1},
    ...
    Biomarker(
        ...
        name_aliases=["ast", "aspartate aminotransferase", "aspartate transaminase",
                      ...
                      "aspartate aminotransferase ser/plas ccnc pt qn"],
        unit_conversions={"u/l": 1, "iu/l": 1, "units/l": 1, "intl_unit/l": 1, "unit per liter": 1, "international unit per liter": 1},
    ...
    Biomarker(
        ...
        unit_conversions={"iu/ml": 1, "u/ml": 1, "international unit per milliliter": 1},
    ...
    Biomarker(
        ...
        name_aliases=["thyroglobulin antibodies", "thyroglobulin antibody",
                      "anti-thyroglobulin", "thyroglobulin ab ser/plas acnc pt qn"],
    ...
    Biomarker(
        ...
        name_aliases=["vitamin b12", "vit b12", "b12", "cobalamin",
                      ...
                      "cobalamins ser/plas mcnc pt qn"],
        unit_conversions={
            "pg/ml": 1, "ng/l": 1,
            "pmol/l": 1.355,
        },
    ...
    Biomarker(
        ...
        name_aliases=["folate", "folic acid", "vitamin b9", "vit b9",
                      ...
                      "folate (folic acid), serum", "folate ser/plas mcnc pt qn"],
        unit_conversions={
            "ng/ml": 1,
            "nmol/l": 0.4413,
        },
    ...
    Biomarker(
        ...
        name_aliases=["iron", "serum iron", "fe", "iron serum", "iron ser/plas mcnc pt qn"],
        unit_conversions={
            "µg/dl": 1, "ug/dl": 1,
    ...
    Biomarker(
        ...
        name_aliases=["tibc", "total iron binding capacity",
                      ...
                      "iron binding capacity ser/plas mcnc pt qn", "iron bind.cap.(tibc)",
                      "iron binding capacity.unsaturated ser/plas mcnc pt qn"],
        unit_conversions={
            "µg/dl": 1, "ug/dl": 1,
            "µmol/l": 5.585, "umol/l": 5.585,
        },
    ...
    Biomarker(
        ...
        name_aliases=["transferrin saturation", "iron saturation",
                      "% saturation", "iron sat", "sat %", "iron saturation ser/plas mfr pt qn"],
        unit_conversions={"%": 1, "percent": 1},
    ...
    Biomarker(
        ...
        canonical_unit="ng/mL",
        category="Iron Studies",
        name_aliases=["ferritin", "serum ferritin", "ferritin serum", "ferritin ser/plas mcnc pt qn"],
    ...
    Biomarker(
        ...
        canonical_unit="mg/dL",
        category="Minerals",
        name_aliases=["magnesium", "mg", "magnesium serum", "magnesium ser/plas mcnc pt qn"],
        unit_conversions={
            "mg/dl": 1,
    ...
    Biomarker(
        ...
        name_aliases=["crp", "c-reactive protein", "c reactive protein",
                      "crp quantitative", "c reactive protein ser/plas mcnc pt qn"],
        unit_conversions={
            "mg/l": 1,
            "mg/dl": 10,
            "nmol/l": 0.1047,
        "milligram per liter": 1},
    ...
    Biomarker(
        ...
        name_aliases=["esr", "erythrocyte sedimentation rate", "sed rate",
                      "sedimentation rate", "westergren esr", "erythrocyte sedimentation rate bld vel pt qn"],
    ...
    Biomarker(
        ...
        name_aliases=["hbsag screen", "hepatitis b surface antigen",
                      "hepatitis b virus surface ag ser/plas prthr pt ord ia"],
        unit_conversions={"": 1},
    ),
    Biomarker(
        canonical_name="RPR",
